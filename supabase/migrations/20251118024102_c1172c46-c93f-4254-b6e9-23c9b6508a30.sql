-- Drop ALL existing policies on ct_newsletter_subscribers
DROP POLICY IF EXISTS "allow_anonymous_inserts" ON public.ct_newsletter_subscribers;
...
-- Create the single clean policy for anonymous inserts
