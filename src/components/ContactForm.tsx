          ...
          <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
            <div className="flex flex-col items-center">
              <a
                ...
                className="w-24 h-24 rounded-full border-2 border-white/30 hover:border-white/50 transition-colors duration-300 flex items-center justify-center group"
              >
                <Telegram className="h-8 w-8 text-white/80 group-hover:text-white" />
              </a>
            ...
            <div className="flex flex-col items-center">
              <a
                ...
                className="w-24 h-24 rounded-full border-2 border-white/30 hover:border-white/50 transition-colors duration-300 flex items-center justify-center group"
              >
                <WhatsApp className="h-8 w-8 text-white/80 group-hover:text-white" />
              </a>
            ...
            <div className="flex flex-col items-center">
              <a
                ...
                className="w-24 h-24 rounded-full border-2 border-white/30 hover:border-white/50 transition-colors duration-300 flex items-center justify-center group"
              >
                <Mail className="h-8 w-8 text-white/80 group-hover:text-white" />
              </a>
            ...
            <div className="flex flex-col items-center">
              <a
                ...
                className="w-24 h-24 rounded-full border-2 border-white/30 hover:border-white/50 transition-colors duration-300 flex items-center justify-center group"
              >
                <Calendar className="h-8 w-8 text-white/80 group-hover:text-white" />
              </a>
