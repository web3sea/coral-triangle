  ...
  <section className="mb-16">
    ...
    <Card className="p-6 bg-entreprenology-bg border border-entreprenology-coral/20 text-gray-300 shadow-lg backdrop-blur-sm">
      <div className="space-y-8">
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-entreprenology-coral flex items-center gap-2">
            📊 CRM
          </h3>
          ...
          <div className="overflow-x-auto mb-8">
            <Table className="w-full border-collapse">
              <TableHeader className="bg-entreprenology-coral/20">
                <TableRow>
                  <TableHead className="text-entreprenology-coral">Created Date</TableHead>
                  <TableHead className="text-entreprenology-coral">Status</TableHead>
                  <TableHead className="text-entreprenology-coral">Lead Source</TableHead>
                  <TableHead className="text-entreprenology-coral">Full Name</TableHead>
                  <TableHead className="text-entreprenology-coral">Stay Dates</TableHead>
                  <TableHead className="text-entreprenology-coral">Group Size</TableHead>
                  <TableHead className="text-entreprenology-coral">Room Type</TableHead>
                  <TableHead className="text-entreprenology-coral">Newsletter Date</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow className="border-t border-entreprenology-coral/20">
          ...
          {/* Second CRM Table */}
          <h4 className="text-lg font-medium text-entreprenology-yellow mb-2">Dive & Preference Details</h4>
          <div className="overflow-x-auto">
            <Table className="w-full border-collapse">
              <TableHeader className="bg-entreprenology-coral/20">
                <TableRow>
                  <TableHead className="text-entreprenology-coral">Email</TableHead>
                  <TableHead className="text-entreprenology-coral">WhatsApp</TableHead>
                  <TableHead className="text-entreprenology-coral">Certification</TableHead>
                  <TableHead className="text-entreprenology-coral">Dietary Needs</TableHead>
                  <TableHead className="text-entreprenology-coral">Equipment Sizes</TableHead>
                  <TableHead className="text-entreprenology-coral">Special Requests</TableHead>
                  <TableHead className="text-entreprenology-coral">Return Guest</TableHead>
                  <TableHead className="text-entreprenology-coral">Country</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow className="border-t border-entreprenology-coral/20">
